...
import com.example.jiayin.helpfordemo.my.fragment.HelpAllOrderFragment;
import com.example.jiayin.helpfordemo.my.fragment.HelpFinishOrderFragment;
import com.example.jiayin.helpfordemo.my.fragment.HelpUnFinishOrderFragment;
...
public class HelpOrderActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        mFragmentList.add(new HelpAllOrderFragment());
        mFragmentList.add(new HelpFinishOrderFragment());
        mFragmentList.add(new HelpUnFinishOrderFragment());
