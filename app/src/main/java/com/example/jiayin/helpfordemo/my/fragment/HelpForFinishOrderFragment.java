...
public class HelpForFinishOrderFragment extends BaseFragment {
    ...
    private void queryOrderMessage() {
        ...
        AVQuery<AVObject> order_message1 = new AVQuery<>("order_message");
        order_message1.whereEqualTo("status", 2);
        AVQuery<AVObject> query = AVQuery.and(Arrays.asList(order_message,order_message1));
