...
public class HelpFinishOrderFragment extends BaseFragment {
    ...
    private void queryOrderMessage() {
        ...
        order_message1.whereEqualTo("status",3);
        AVQuery<AVObject> query1 = AVQuery.and(Arrays.asList(order_message,order_message1));
