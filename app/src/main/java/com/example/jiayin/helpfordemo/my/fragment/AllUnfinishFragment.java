...
public class AllUnfinishFragment extends BaseFragment {
    ...
    private void queryOrderMessage() {
        ...
        order_message.whereEqualTo("userId", EMClient.getInstance().getCurrentUser());
        final AVQuery<AVObject> order_message4 = new AVQuery<>("order_message");
        order_message4.whereEqualTo("handuserid", EMClient.getInstance().getCurrentUser());
        AVQuery<AVObject> query2 = AVQuery.or(Arrays.asList(order_message,order_message4));
        ...
        AVQuery<AVObject> query1 = AVQuery.and(Arrays.asList(query,query2));
