...
import com.example.jiayin.helpfordemo.chat.activity.AddContactActivity;
import com.example.jiayin.helpfordemo.chat.activity.ChatActivity;
import com.example.jiayin.helpfordemo.chat.activity.GroupListActivity;
import com.example.jiayin.helpfordemo.chat.activity.HxUserDetailActivity;
import com.example.jiayin.helpfordemo.chat.activity.InviteActivity;
...
import com.example.jiayin.helpfordemo.chat.utils.SpUtils;
...
//                Intent intent = new Intent(getActivity(), HxUserDetailActivity.class);
                Intent intent = new Intent(getActivity(), ChatActivity.class);
                // 传递参数
                intent.putExtra(EaseConstant.EXTRA_USER_ID, user.getUsername());
                startActivity(intent);
                Toast.makeText(getActivity(),"跳转到"+user.getUsername()+"的聊天页面",Toast.LENGTH_SHORT).show();
                Log.d(TAG, "onListItemClicked: " + "跳转到"+user.getUsername()+"的聊天页面");
            }
        });
        ...
        LinearLayout ll_new_friend = headerView.findViewById(R.id.ll_new_friend);
    ...
    protected void setUpView() {
        ...
        ll_contact_invite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                Toast.makeText(getActivity(),"跳转到申请与通知",Toast.LENGTH_SHORT).show();
            }
        });
        // 注册广播
